...
@SET GRADLE_PATH=%CMDER_PATH%\tools\gradle-1.11
@SET DEPOT_TOOLS_PATH=%CYGWIN_PATH%\opt\depot_tools
@SET PYTHON_PATH=%DEPOT_TOOLS_PATH%\python276_bin
@SET PATH=%CYGWIN_PATH%\bin;%CYGWIN_PATH%\usr\sbin;%JAVA_PATH%\bin;%JDK_PATH%\bin;%GRADLE_PATH%\bin;%DEPOT_TOOLS_PATH%;%PYTHON_PATH%;%PATH%
